...
import coffee.khyonieheart.aurora.rpg.skill.AbstractSkill;
import coffee.khyonieheart.aurora.rpg.skill.SkillAlchemist;
import coffee.khyonieheart.aurora.rpg.skill.SkillArchaeologist;
import coffee.khyonieheart.aurora.rpg.skill.SkillAutoReplant;
import coffee.khyonieheart.aurora.rpg.skill.SkillCleanBlows;
import coffee.khyonieheart.aurora.rpg.skill.SkillDazeMob;
import coffee.khyonieheart.aurora.rpg.skill.SkillDoubleMend;
import coffee.khyonieheart.aurora.rpg.skill.SkillEmeraldHill;
import coffee.khyonieheart.aurora.rpg.skill.SkillFarmhand;
import coffee.khyonieheart.aurora.rpg.skill.SkillForgemaster;
import coffee.khyonieheart.aurora.rpg.skill.SkillNinjaTraining;
import coffee.khyonieheart.aurora.rpg.skill.SkillQuadrupleOres;
import coffee.khyonieheart.aurora.rpg.skill.SkillRefundArrow;
import coffee.khyonieheart.aurora.rpg.skill.SkillSilkSpawners;
import coffee.khyonieheart.aurora.rpg.skill.SkillSwanSong;
import coffee.khyonieheart.aurora.rpg.skill.SkillVeinMiner;
import coffee.khyonieheart.aurora.rpg.skill.SkillWakingRush;
import coffee.khyonieheart.aurora.rpg.skill.SkillWellRested;
...
public class RpgStatListener implements Listener
{
    ...
    {
        if (trySkill(event, event.getEntity().getKiller(), AuroraSkill.REANIMATION))
            return;
    }
